...
type FakeSession = {
	...
	_truncatedOutputContinuations: number;
...
function fakeSession(overrides: Partial<FakeSession> = {}): FakeSession {
	const session: FakeSession = {
		...
		_truncatedOutputContinuations: 0,
	...
	const realMethods = [
		...
		// Output-limit stop recovery runs ahead of the gate in
		// _getContinuationMessages and is a no-op for these non-truncated turns.
		"_getTruncatedOutputContinuation",
	] as const;
