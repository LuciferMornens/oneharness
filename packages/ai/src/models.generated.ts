...
export const MODELS = {
	...
	"adverserial": {
		"lordx64/cyberglm": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"openai"},
			reasoning: true,
	...
	"amazon-bedrock": {
		"amazon.nova-2-lite-v1:0": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"off","minimal":null,"low":"low","medium":"medium","high":"high","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.33,
				output: 2.75,
		...
		"anthropic.claude-fable-5": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 10,
				output: 50,
		...
		"anthropic.claude-haiku-4-5-20251001-v1:0": {
			...
			baseUrl: "https://bedrock-runtime.us-east-1.amazonaws.com",
			reasoning: true,
			reasoningCapabilities: {"control":"budget","levels":{"minimal":1024,"low":2048,"medium":8192,"high":16384},"supportsOff":true},
			input: ["text", "image"],
			cost: {
				input: 1,
				output: 5,
		...
		"anthropic.claude-opus-4-6-v1": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"off","low":"low","medium":"medium","high":"high","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"anthropic.claude-opus-4-7": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"off","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"deepseek.r1-v1:0": {
			...
			baseUrl: "https://bedrock-runtime.us-east-1.amazonaws.com",
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"always"},
	...
	"audn": {
		...
		"k3-thinker-qwen38": {
			...
			provider: "audn",
			baseUrl: "https://platform.audn.ai/api/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":true,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"openai"},
			reasoning: true,
			thinkingLevelMap: {"off":null,"minimal":null,"low":"low","medium":null,"high":"high","xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":null,"low":"low","medium":null,"high":"high","xhigh":null,"max":"max"}},
			input: ["text"],
			cost: {
				input: 4,
				output: 21,
		...
		"pingu-unchained-10": {
			...
			provider: "audn",
			baseUrl: "https://platform.audn.ai/api/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":true,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false},
			reasoning: false,
			input: ["text"],
			cost: {
				input: 2,
	...
	"azure-openai-responses": {
		...
		"gpt-5": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 10,
		...
		"gpt-5-pro": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 15,
				output: 120,
		...
		"gpt-5.1": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","minimal":null,"low":"low","medium":"medium","high":"high","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 10,
		...
		"gpt-5.1-codex": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":null,"low":"low","medium":"medium","high":"high","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 5,
		...
		"gpt-5.2": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","minimal":null,"low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
		...
		"gpt-5.2-chat-latest": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":null,"low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
		...
		"gpt-5.2-pro": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":null,"low":null,"medium":"medium","high":"high","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 21,
				output: 168,
		...
		"gpt-5.6": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","minimal":null,"low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 4,
				output: 20,
		...
		"gpt-realtime-2.1": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":"minimal","low":"low","medium":"medium","high":"high"}},
			input: ["text", "image"],
			cost: {
				input: 4,
				output: 24,
	...
	"cerebras": {
		"gpt-oss-120b": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":"low","medium":"medium","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":"low","medium":"medium","xhigh":null,"max":null}},
			input: ["text"],
			cost: {
				input: 0.35,
				output: 0.75,
	...
	"deepseek": {
		"deepseek-flash": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":"off","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":"xhigh","max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"off","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 0.3,
				output: 1.2,
		...
		"deepseek-v4-flash": {
			...
			compat: {"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"deepseek"},
			reasoning: true,
			thinkingLevelMap: {"off":"off","high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"off","high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":"max"}},
			input: ["text"],
			cost: {
				input: 0.14,
				output: 0.28,
	...
	"fireworks": {
		"accounts/fireworks/models/deepseek-v4-flash": {
			...
			reasoning: true,
			reasoningCapabilities: {"control":"budget","levels":{"minimal":1024,"low":2048,"medium":8192,"high":16384,"xhigh":32768,"max":65536},"supportsOff":true},
			input: ["text"],
			cost: {
				input: 0.14,
				output: 0.28,
	...
	"google": {
		"gemini-2.5-flash": {
			...
			reasoning: true,
			reasoningCapabilities: {"control":"budget","levels":{"off":0,"minimal":128,"low":2048,"medium":8192,"high":24576,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.3,
				output: 2.5,
		...
		"gemini-2.5-flash-lite": {
			...
			baseUrl: "https://generativelanguage.googleapis.com/v1beta",
			reasoning: true,
			reasoningCapabilities: {"control":"budget","levels":{"off":0,"minimal":512,"low":2048,"medium":8192,"high":24576,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.1,
				output: 0.4,
		...
		"gemini-2.5-pro": {
			...
			baseUrl: "https://generativelanguage.googleapis.com/v1beta",
			reasoning: true,
			reasoningCapabilities: {"control":"budget","levels":{"off":null,"minimal":128,"low":2048,"medium":8192,"high":32768,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 10,
		...
		"gemma-4-26b-a4b-it": {
			...
			baseUrl: "https://generativelanguage.googleapis.com/v1beta",
			reasoning: true,
			thinkingLevelMap: {"off":"MINIMAL","high":"HIGH","minimal":null,"low":null,"medium":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"MINIMAL","high":"HIGH","minimal":null,"low":null,"medium":null}},
			input: ["text", "image"],
			cost: {
				input: 0,
				output: 0,
	...
	"google-vertex": {
		...
		"gemini-3-pro-preview": {
			...
			baseUrl: "https://{location}-aiplatform.googleapis.com",
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"HIGH","minimal":null,"low":"LOW","medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"HIGH","minimal":null,"low":"LOW","medium":null,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 2,
				output: 12,
	...
	"grok": {
		...
		"grok-4.6": {
			...
			baseUrl: "https://cli-chat-proxy.grok.com/v1",
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 2,
				output: 6,
	...
	"groq": {
		...
		"qwen/qwen3.6-27b": {
			...
			baseUrl: "https://api.groq.com/openai/v1",
			reasoning: true,
			thinkingLevelMap: {"off":"off","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"toggle","levels":{"off":"off","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.6,
				output: 3,
	...
	"huggingface": {
		...
		"moonshotai/Kimi-K3": {
			...
			compat: {"supportsDeveloperRole":false},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":null,"minimal":null,"low":null,"medium":null,"xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"toggle","levels":{"off":null,"high":null,"minimal":null,"low":null,"medium":null,"xhigh":null,"max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 3,
				output: 15,
	...
	"mistral": {
		...
		"mistral-medium-2604": {
			...
			baseUrl: "https://api.mistral.ai",
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.5,
				output: 7.5,
		...
		"zai-glm-5-2": {
			...
			reasoningCapabilities: {"control":"toggle","levels":{"off":"off","high":"high"}},
			input: ["text"],
			cost: {
				input: 1.4,
				output: 4.4,
	...
	"moonshotai": {
		"kimi-k2.6": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"moonshot"},
			reasoning: true,
			thinkingLevelMap: {"off":"disabled","minimal":null,"low":null,"medium":null,"high":"enabled","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"toggle","levels":{"off":"disabled","minimal":null,"low":null,"medium":null,"high":"enabled","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.95,
				output: 4,
	...
	"openai-codex": {
		...
		"gpt-5.1-codex-mini": {
			...
			baseUrl: "https://chatgpt.com/backend-api",
			reasoning: true,
			thinkingLevelMap: {"off":null,"minimal":"medium","low":"medium","medium":"medium","high":"high","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":"medium","low":"medium","medium":"medium","high":"high","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.25,
				output: 2,
		...
		"gpt-5.2": {
			...
			baseUrl: "https://chatgpt.com/backend-api",
			reasoning: true,
			thinkingLevelMap: {"off":"none","minimal":"low","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","minimal":"low","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
		...
		"gpt-5.2-codex": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":"low","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
	...
	"opencode": {
		...
		"muse-spark-1.3": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 4.25,
	...
	"openrouter": {
		"aion-labs/aion-2.0": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"toggle","levels":{"off":null,"high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null}},
			input: ["text"],
			cost: {
		...
		"amazon/nova-2-lite-v1": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"toggle","levels":{"off":"none","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.3,
				output: 2.5,
		...
		"anthropic/claude-fable-5": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 10,
				output: 50,
		...
		"anthropic/claude-opus-4.6": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":null,"max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"anthropic/claude-opus-4.7": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"auto": {
			...
			reasoningCapabilities: {"control":"toggle","levels":{"off":"none","high":"high"}},
			input: ["text", "image"],
			cost: {
				input: 0,
				output: 0,
		...
		"bytedance-seed/seed-2.0-code": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.5,
				output: 3,
		...
		"bytedance-seed/seed-2.0-lite": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.25,
				output: 2,
		...
		"deepseek/deepseek-v4-flash": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","minimal":null,"low":null,"medium":null,"high":"high","xhigh":"xhigh","max":null}},
			input: ["text"],
			cost: {
				input: 0.088606,
				output: 0.177212,
		...
		"deepseek/deepseek-v4-flash-0731": {
			...
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","minimal":null,"low":"low","medium":null,"high":"high","xhigh":null,"max":"max"}},
			input: ["text"],
			cost: {
				input: 0.065,
				output: 0.18,
		...
		"deepseek/deepseek-v4-flash-vision-exp": {
			...
			compat: {"supportsReasoningEffort":true,"thinkingFormat":"openrouter"},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 0.22,
				output: 0.66,
		...
		"google/gemini-3.5-flash": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.5,
				output: 9,
		...
		"ibm-granite/granite-4.2-8b": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":null}},
			input: ["text"],
			cost: {
				input: 0.06,
				output: 0.25,
		...
		"meta/muse-spark-1.1": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 4.25,
		...
		"nex-agi/nex-n2.5-mini:free": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":null,"medium":"medium","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":null,"medium":"medium","xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 0,
				output: 0,
		...
		"nvidia/nemotron-3-super-120b-a12b": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":null,"minimal":null,"low":"low","medium":"medium","xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":null,"minimal":null,"low":"low","medium":"medium","xhigh":null,"max":null}},
			input: ["text"],
			cost: {
		...
		"openai/gpt-5-pro": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null}},
			input: ["text", "image"],
			cost: {
				input: 15,
				output: 120,
		...
		"openai/gpt-5.2": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
		...
		"openai/gpt-5.2-pro": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":null,"medium":"medium","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":null,"medium":"medium","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 21,
				output: 168,
		...
		"qwen/qwen3.8-2.4t-a95b": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":null,"minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":null,"minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null}},
			input: ["text"],
			cost: {
				input: 2,
				output: 6,
		...
		"qwen/qwen3.8-27b": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":null,"minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":null,"minimal":null,"low":"low","medium":"medium","xhigh":"xhigh","max":null}},
			input: ["text", "image"],
			cost: {
				input: 0.42,
				output: 3,
		...
		"sakana/fugu-ultra": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":null,"medium":null,"xhigh":"xhigh","max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":null,"medium":null,"xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 30,
		...
		"thinkingmachines/inkling": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":null,"max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 1,
				output: 4.05,
		...
		"z-ai/glm-5.2": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":null,"low":null,"medium":null,"xhigh":"xhigh","max":null},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":null,"low":null,"medium":null,"xhigh":"xhigh","max":null}},
			input: ["text"],
			cost: {
				input: 0.28,
				output: 0.88,
		...
		"z-ai/glm-5.3": {
			...
			compat: {"supportsReasoningEffort":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":null,"high":"high","minimal":null,"low":"low","medium":null,"xhigh":null,"max":"max"}},
			input: ["text"],
			cost: {
				input: 1.4,
				output: 4.4,
	...
	"prime-inference": {
		...
		"z-ai/glm-5.2": {
			...
			provider: "prime-inference",
			baseUrl: "https://api.pinference.ai/api/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"zai"},
			reasoning: true,
			thinkingLevelMap: {"off":"off","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"off","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":"max"}},
			input: ["text"],
			cost: {
				input: 1.54,
				output: 4.84,
	...
	"vercel-ai-gateway": {
		...
		"thinkingmachines/inkling": {
			...
			baseUrl: "https://ai-gateway.vercel.sh",
			reasoning: true,
			thinkingLevelMap: {"off":"none","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":"xhigh","max":"max"},
			reasoningCapabilities: {"control":"effort","levels":{"off":"none","high":"high","minimal":"minimal","low":"low","medium":"medium","xhigh":"xhigh","max":"max"}},
			input: ["text", "image"],
			cost: {
				input: 1,
				output: 4.05,
	...
	"zai": {
		"glm-4.7": {
			...
			compat: {"supportsDeveloperRole":false,"supportsReasoningEffort":false,"thinkingFormat":"zai","zaiToolStream":true},
			reasoning: true,
			thinkingLevelMap: {"off":"off","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null},
			reasoningCapabilities: {"control":"toggle","levels":{"off":"off","high":"high","minimal":null,"low":null,"medium":null,"xhigh":null,"max":null}},
			input: ["text"],
