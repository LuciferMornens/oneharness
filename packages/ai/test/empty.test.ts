...
describe("AI Providers Empty Message Tests", () => {
	...
	describe.skipIf(!process.env.AUDN_API_KEY)("audn.ai Provider Empty Messages", () => {
	...
	describe.skipIf(!process.env.ADVERSERIAL_API_KEY)("Adverserial AI Provider Empty Messages", () => {
	...
	describe.skipIf(!process.env.ORCAROUTER_API_KEY)("OrcaRouter Provider Empty Messages", () => {
