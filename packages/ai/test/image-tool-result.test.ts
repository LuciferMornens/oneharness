...
describe("Tool Results with Images", () => {
	...
	describe.skipIf(!process.env.ADVERSERIAL_API_KEY)("Adverserial AI Provider (lordx64/cyberkimi)", () => {
	...
	describe.skipIf(!process.env.ORCAROUTER_API_KEY)("OrcaRouter Provider (orcarouter/auto)", () => {
